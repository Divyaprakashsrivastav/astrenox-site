        ...
        {s.useCases.map((uc, i) => {
          ...
          return (
            <motion.article
              ...
              className={`enterprise-card p-5 ${uc.id === "decision" ? "md:col-span-2 lg:col-span-1" : ""}`}
            >
              ...
              <p className="mt-2 text-sm text-muted leading-relaxed"><FormattedText text={uc.description} /></p>
            </motion.article>
          );
        })}
      </div>
