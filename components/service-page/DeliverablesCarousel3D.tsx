...
export type DeliverableCarouselItem = {
  ...
  afterBullets?: string[];
  description?: string;
  /** Optional image shown at the top of the carousel panel. */
  photo?: string;
};
    ...
    >
      <div className="svc-deliverable-carousel-card">
        <AnimatePresence mode="wait">
          ...
          >
            {activeItem.photo ? (
              <div className="svc-deliverable-carousel-photo" aria-hidden>
                <Image
                  src={activeItem.photo}
                  alt=""
                  fill
                  sizes="(max-width: 640px) 92vw, 740px"
                  className="svc-deliverable-carousel-photo-img"
                />
              </div>
            ) : (
              <div className="svc-deliverable-carousel-photo svc-deliverable-carousel-photo--fallback" aria-hidden />
            )}
