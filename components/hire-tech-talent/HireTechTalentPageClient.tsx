          ...
          {open && (
            ...
            >
              <div className="mvp-step-inner">
                <p className="mvp-step-desc"><FormattedText text={model.description} /></p>
    ...
    <Canvas>
      ...
      <section className="mvp-inner mvp-section" aria-labelledby="htt-capabilities">
        <div className="mvp-section-header">
          ...
          <p className="mvp-section-intro"><FormattedText text={capabilities.intro} /></p>
        </div>
        <motion.div
      ...
      <section className="mvp-inner mvp-section" aria-labelledby="htt-advantages">
        <div className="mvp-section-header">
          ...
          <p className="mvp-section-intro"><FormattedText text={advantages.intro} /></p>
        </div>
        <motion.div
          className="mvp-grid-2"
          variants={stagger}
      ...
      >
        <div className="mvp-section-header">
          ...
          <p className="mvp-section-intro"><FormattedText text={engagement.intro} /></p>
        </div>
      ...
      <section className="mvp-inner mvp-section" aria-label={brand}>
        <div className="mvp-glass mvp-cta">
          <h2>{brand}</h2>
          <p className="htt-cta-text"><FormattedText text={hero.description} /></p>
