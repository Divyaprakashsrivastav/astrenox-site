          ...
          <div className="pp-offerings-grid">
            {productOfferings.map((offering, i) => (
              ...
              >
                ...
                <p className="pp-offering-desc"><FormattedText text={offering.description} /></p>
          ...
          <div className="pp-infra-grid">
            {productsInfrastructurePlatforms.map((platform, i) => (
              ...
              >
                ...
                <p className="pp-infra-desc"><FormattedText text={platform.description} /></p>
          ...
          <div className="pp-compare-grid">
            {productsInfrastructurePlatforms.map((platform, i) => (
              ...
              >
                ...
                <p className="pp-compare-desc"><FormattedText text={platform.description} /></p>
