      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="mt-6">
            ...
            <p className="products-body mt-3"><FormattedText text={overview.strategicOverview.text} /></p>
          </div>
          ...
          <div className="mt-8">
            ...
            <p className="products-body mt-3"><FormattedText text={overview.businessValue.text} /></p>
          </div>
        </motion.div>
      </AnimatePresence>
      ...
      <div className="mt-8">
        <ProductsAccordion
          ...
          items={industrySolutionsSection.detailed.map((industry) => ({
            ...
            content: (
              <>
                <p className="products-body"><FormattedText text={industry.intro} /></p>
