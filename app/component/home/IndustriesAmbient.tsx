...
export default function IndustriesAmbient() {
  ...
  useEffect(() => {
    ...
    canvas.className = "ind-ambient-canvas";
  ...
  return (
    <div ref={mountRef} className="ind-ambient" aria-hidden="true">
      <div className="ind-ambient-gradient" />
      <div className="ind-ambient-noise" />
    </div>
  );
}
