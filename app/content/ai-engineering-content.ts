/** Verbatim from approved AI Engineering & Development content only. */
export const aiEngineeringPageContent = {
  ...
  hero: {
    ...
    trustLine:
      "Engineering deterministic, scalable AI systems for complex environments with zero data retention and enterprise-grade security.",
  },
  overview: {
  ...
  engineeringCapabilities: {
    ...
    intro:
      "We replace brittle manual workflows with dynamic, scalable architectures.",
    items: [
      {
        capability: "AI Agents & Workflow Automation",
        technicalFocus:
          "Stateful agent orchestration using internal APIs to turn manual processes into dynamic, LLM-driven decision trees.",
        businessOutcome:
          "Reduce manual effort by 70–90% and intelligently unblock bottlenecks.",
      },
      {
        capability: "Secure Data Retrieval Systems",
        technicalFocus:
      ...
      },
      {
        ...
        technicalFocus:
          "Architecting context-aware semantic graphs and persistent, multi-session memory architectures.",
        businessOutcome:
          "Enable deeply contextual, hyper-personalized AI interactions that compound in accuracy and intelligence over time.",
      },
      {
        capability: "Custom AI Product Development",
        technicalFocus:
          "Full-stack engineering of scalable web applications with a proprietary AI computational core.",
        businessOutcome:
          "Deploy market-ready, defensible AI tools without accruing technical debt.",
      },
      {
        capability: "MLOps & Continuous Evaluation",
        technicalFocus:
          "Automated CI/CD regression testing, AI-as-a-Judge evaluations, and real-time telemetry.",
        businessOutcome:
          "Total visibility over production workloads to ensure stability, compliance, and ROI at scale.",
      },
    ],
  },
  stack: {
    ...
    intro:
      "We utilize a decoupled, modular architecture to prevent vendor lock-in, enforce strict data boundaries, and allow for rapid model swapping as the AI landscape evolves.",
    items: [
      {
  ...
  interventions: {
    label: "Use Cases",
    title: "Deployed Enterprise Use Cases",
    intro:
      "We build production-grade software tied to real operating work, not just demos. Our core enterprise implementations include:",
    items: [
      {
  ...
  workflow: {
    ...
    intro:
      "We utilize rapid deployment cycles that shorten time-to-impact from months to weeks.",
    steps: [
      {
        name: "Discovery & Architecture",
        description:
          "Scoping technical requirements, mapping data dependencies, selecting foundational models, and designing a secure, vendor-agnostic blueprint.",
      },
      {
        name: "Functional Prototyping",
        description:
          "Rapid deployment of a core baseline to validate model capability, prompt efficiency, and data retrieval accuracy before heavy scaling.",
      },
      {
        name: "Full-Stack Engineering & Integration",
        description:
          "Core code buildout across frontends, backend APIs, ingestion pipelines, and multi-agent state machines, integrating seamlessly into your existing CRMs, ERPs, and databases.",
      },
      {
        name: "Security & Guardrails",
        description:
          "Implementation of latency optimization, prompt injection defenses, and rigorous output sanitization.",
      },
      {
        name: "Deployment & Continuous MLOps",
        description:
          "CI/CD pipeline rollout, containerized deployment (Docker/Kubernetes), and post-launch telemetry tuning using automated dataset experiments.",
      },
    ],
  },
  security: {
    ...
    intro:
      "We design AI systems for regulated and high-stakes environments. Consumer-grade privacy is not enough.",
    items: [
      {
  ...
  deliverables: {
    label: "Deliverables",
    title: "Tangible Engineering Artifacts",
    intro:
      "We prioritize clean handoffs and total transparency. Every engagement concludes with fully documented IP ownership belonging to you.",
    items: [
      {
  ...
  serviceOfferings: {
    ...
    intro: "We adapt to your team's current maturity and resource availability.",
    items: [
      {
        service: "End-to-End Build",
        outcome:
          "We act as your outsourced AI product team, taking the project from initial scoping to final production deployment and ongoing MLOps management.",
      },
      {
        service: "Co-Engineering & Acceleration",
        outcome:
          "We embed our senior AI architects alongside your existing software engineering team to guide best practices, unblock technical hurdles, and accelerate your time to market.",
      },
    ],
  },
  faq: {
    ...
    items: [
      {
        q: "How long does an AI workflow automation take to deploy?",
        a: "Focused automations can often go live in 4 to 6 weeks. Broader, multi-system platforms take longer depending on security reviews, custom integrations, and workflow complexity. We utilize phased rollouts so you see ROI early, rather than waiting for a massive, delayed launch.",
      },
      {
        q: "Can you build AI workflow automation inside our existing systems?",
        a: "Yes. We regularly integrate with Salesforce, HubSpot, SAP, Snowflake, SharePoint, internal APIs, and legacy databases. We build the AI system to operate silently and efficiently inside the environment your team already uses.",
      },
      {
        q: "What makes your AI engineering approach different?",
        a: "We combine senior product-minded engineering with a strict vendor-agnostic architecture. We design systems around your workflows and security constraints, rather than forcing your business to adapt to whichever tool or model happens to be trending this month.",
      },
    ],
  },
  cta: {
