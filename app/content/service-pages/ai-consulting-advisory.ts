...
export const aiConsultingAdvisoryContent: ServicePageContent = {
  metadata: {
  ...
  workflow: {
    id: "framework",
    label: "Framework",
    title: "The 6-Step Strategy Framework",
    steps: [
      {
  ...
  interventions: {
    label: "Interventions",
    title: "Targeted Architectural Interventions",
    items: [
      {
  ...
  stack: {
    label: "Deliverables",
    title: "Tangible Technical Artifacts",
    items: [
      {
        ...
        icon: "FileCheck",
        photo: "/images/advisory/readiness.png",
      },
      {
        ...
        icon: "BarChart3",
        photo: "/images/advisory/usecase-matrix.png",
      },
      {
        ...
        icon: "Layers",
        photo: "/images/advisory/infra-blueprint.png",
      },
      {
        ...
        icon: "GitBranch",
        photo: "/images/advisory/sequencing.png",
      },
    ],
  },
  cta: {
